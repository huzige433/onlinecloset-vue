    ...
    <div class="mycontainer">
        <el-form :inline="true" ref="form" label-width="auto">
            ...
            <el-form-item label="上裆">
                <el-input type="text" v-model="form.crotchup" :disabled="inputdisable"></el-input>
            </el-form-item>
            <el-form-item label="裤内裆长">
                <el-input type="text" v-model="form.inseamlength" :disabled="inputdisable"></el-input>
            </el-form-item>
